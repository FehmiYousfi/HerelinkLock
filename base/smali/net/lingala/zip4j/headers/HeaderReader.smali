...
.method private readAesExtraDataRecord(Lnet/lingala/zip4j/model/FileHeader;Lnet/lingala/zip4j/util/RawIO;)V
    ...
    .line 632
    invoke-virtual {p1, p2}, Lnet/lingala/zip4j/model/FileHeader;->setAesExtraDataRecord(Lnet/lingala/zip4j/model/AESExtraDataRecord;)V

    .line 633
    sget-object p2, Lnet/lingala/zip4j/model/enums/EncryptionMethod;->AES:Lnet/lingala/zip4j/model/enums/EncryptionMethod;

    invoke-virtual {p1, p2}, Lnet/lingala/zip4j/model/FileHeader;->setEncryptionMethod(Lnet/lingala/zip4j/model/enums/EncryptionMethod;)V
...
.method private readAesExtraDataRecord(Lnet/lingala/zip4j/model/LocalFileHeader;Lnet/lingala/zip4j/util/RawIO;)V
    ...
    .line 644
    invoke-virtual {p1, p2}, Lnet/lingala/zip4j/model/LocalFileHeader;->setAesExtraDataRecord(Lnet/lingala/zip4j/model/AESExtraDataRecord;)V

    .line 645
    sget-object p2, Lnet/lingala/zip4j/model/enums/EncryptionMethod;->AES:Lnet/lingala/zip4j/model/enums/EncryptionMethod;

    invoke-virtual {p1, p2}, Lnet/lingala/zip4j/model/LocalFileHeader;->setEncryptionMethod(Lnet/lingala/zip4j/model/enums/EncryptionMethod;)V
...
.method private readZip64ExtendedInfo(Ljava/util/List;Lnet/lingala/zip4j/util/RawIO;JJJI)Lnet/lingala/zip4j/model/Zip64ExtendedInfo;
    ...
    .line 483
    invoke-virtual {p2, v2, v1}, Lnet/lingala/zip4j/util/RawIO;->readLongLittleEndian([BI)J
    ...
    .line 498
    invoke-virtual {p2, v2, v1}, Lnet/lingala/zip4j/util/RawIO;->readIntLittleEndian([BI)I
...
.method public readLocalFileHeader(Ljava/io/InputStream;Ljava/nio/charset/Charset;)Lnet/lingala/zip4j/model/LocalFileHeader;
    ...
    invoke-virtual {v0, v7}, Lnet/lingala/zip4j/model/LocalFileHeader;->setEncrypted(Z)V
    ...
    invoke-virtual {v0, v7}, Lnet/lingala/zip4j/model/LocalFileHeader;->setDataDescriptorExists(Z)V
    ...
    invoke-virtual {v0, v8}, Lnet/lingala/zip4j/model/LocalFileHeader;->setFileNameUTF8Encoded(Z)V
    ...
    invoke-virtual {v0, v5}, Lnet/lingala/zip4j/model/LocalFileHeader;->setGeneralPurposeFlag([B)V
    ...
    invoke-virtual {v0, v5}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCompressionMethod(Lnet/lingala/zip4j/model/enums/CompressionMethod;)V
    ...
    invoke-virtual {v0, v8, v9}, Lnet/lingala/zip4j/model/LocalFileHeader;->setLastModifiedTime(J)V
    ...
    invoke-virtual {v0, v8, v9}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCrc(J)V
    ...
    invoke-virtual {v0, v8, v9}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCompressedSize(J)V
    ...
    :cond_4
    :goto_0
    invoke-virtual {v0, v7}, Lnet/lingala/zip4j/model/LocalFileHeader;->setDirectory(Z)V

    goto :goto_1

    .line 571
    :cond_5
    invoke-virtual {v0, v4}, Lnet/lingala/zip4j/model/LocalFileHeader;->setFileName(Ljava/lang/String;)V
