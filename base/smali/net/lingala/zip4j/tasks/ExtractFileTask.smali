...
.method private createZipInputStream(Lnet/lingala/zip4j/model/FileHeader;Lnet/lingala/zip4j/model/Zip4jConfig;)Lnet/lingala/zip4j/io/inputstream/ZipInputStream;
    ...
    iget-object v1, p0, Lnet/lingala/zip4j/tasks/ExtractFileTask;->password:[C

    invoke-direct {p1, v0, v1, p2}, Lnet/lingala/zip4j/io/inputstream/ZipInputStream;-><init>(Ljava/io/InputStream;[CLnet/lingala/zip4j/model/Zip4jConfig;)V
...
.method protected executeTask(Lnet/lingala/zip4j/tasks/ExtractFileTask$ExtractFileTaskParameters;Lnet/lingala/zip4j/progress/ProgressMonitor;)V
    ...
    .line 46
    :cond_1
    iget-object p1, p0, Lnet/lingala/zip4j/tasks/ExtractFileTask;->splitInputStream:Lnet/lingala/zip4j/io/inputstream/SplitInputStream;

    if-eqz p1, :cond_2

    .line 47
    invoke-virtual {p1}, Lnet/lingala/zip4j/io/inputstream/SplitInputStream;->close()V
    ...
    .line 46
    iget-object p2, p0, Lnet/lingala/zip4j/tasks/ExtractFileTask;->splitInputStream:Lnet/lingala/zip4j/io/inputstream/SplitInputStream;

    if-eqz p2, :cond_4

    .line 47
    invoke-virtual {p2}, Lnet/lingala/zip4j/io/inputstream/SplitInputStream;->close()V
